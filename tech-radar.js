        ...
        .each(function (d, c) {
            ...
            radarCircle
                ...
                .attr("cx", function (d, i) {
                    return rScale(1 - d.value) * Math.cos(angleSlice * c - Math.PI / 4);
                })
                .attr("cy", function (d, i) {
                    return rScale(1 - d.value) * Math.sin(angleSlice * c - Math.PI / 4);
                })
            ...
            radarCircle
                ...
                .attr("y", function (d, i) {
                    return rScale(1 - d.value) * Math.sin(angleSlice * c - Math.PI / 4) + (cfg.dotRadius / 2.5);
                })
                .attr("text-anchor", "middle");
        });
}
